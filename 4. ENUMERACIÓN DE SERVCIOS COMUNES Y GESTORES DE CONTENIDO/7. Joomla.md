...
Se puede ingresar al reporte que nos genera si vamos a:
```bash
/usr/share/joomscan/reports/<nombre_de_la_pagina_WEB>
```
>[!TIp]
> Renombrar el archivo .html a index.html

>[!note]
> Puedes montar un servidor para ver el .html con "python3 -m http.server 80"
>
