...
## sslyze
Inspeccionar para detectar vulnerabilidades 
```python 
sslyze tinder.com
```
## sslscan
Detectar vulnerabilidades, versiones anticuadas
```java 
...
-- Sin DNS
sslscan 172.17.0.1:8443
```
## nmap
```bash
--Reconocimiento con todos los scripts
nmap -sCV -p8443 172.17.0.1

--Aplicar un script especifico
nmap --script ssl-heartbleed -p8443 172.17.0.1
```
